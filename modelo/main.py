...
print(f"- Coeficiente para 'horas_capacitación' (b1): {model.coef_[0]:.4f} (Valor real: 0.1)")
print(f"- Coeficiente para 'antiguedad' (b2): {model.coef_[1]:.4f} (Valor real: 0.25)")
print(f"- Coeficiente para 'calificación_previa' (b3): {model.coef_[2]:.4f} (Valor real: 8.0)")
